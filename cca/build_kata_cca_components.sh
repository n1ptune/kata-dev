...
sudo rm build -rf
make kernel-cca-confidential-tarball shim-v2-tarball qemu-cca-experimental-tarball rootfs-cca-confidential-image-tarball rootfs-cca-confidential-initrd-tarball
